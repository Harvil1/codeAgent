...
async def test_no_brief_when_not_compressed():
...
async def test_brief_omits_todo_when_empty():
...
async def test_brief_marks_plan_mode_when_true():
...
async def test_brief_marks_normal_mode_when_false():
...
async def test_brief_not_in_conversation_history():
