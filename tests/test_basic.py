...
def test_registry_register_and_dispatch():
    ...
    result = registry.dispatch("test_tool_basic", {})
...
def test_registry_handler_exception():
    ...
    result = registry.dispatch("test_tool_bad", {})
    data = json.loads(result)
    assert data["error_type"] == "tool_exception"
    assert "boom" in data["error"]


def test_registry_dict_result_normalized():
    ...
    result = registry.dispatch("test_tool_dict", {})
