---
name: writing-plans
description: "为多步任务写实现计划:拿到 spec 或需求、动代码之前,把复杂任务拆成 bite-size 的可执行步骤并文档化(含文件结构、测试、Global Constraints、Self-Review)。 | Use when you have a spec or requirements for a multi-step task, before touching code"
---
