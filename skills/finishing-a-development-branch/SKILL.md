...
description: "当实现完成、所有测试通过，需要决定如何收尾集成开发工作（合并、PR 或清理分支）时使用 | Use when implementation is complete, all tests pass, and you need to decide how to integrate the work"
---
...
**Otherwise:** An external host created this workspace (e.g. a manually created worktree). Do NOT remove it — leave the workspace in place.
