...
description: "面对 2+ 个相互独立、无共享状态或顺序依赖的任务时使用，并行派发子代理。| Use when facing 2+ independent tasks that can be worked on without shared state or sequential dependencies"
---
