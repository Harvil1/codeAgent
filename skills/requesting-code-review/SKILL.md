...
description: 完成任务、实现主要功能或合并前，派发评审子代理验证工作是否满足需求 | Use when completing tasks, implementing major features, or before merging to verify work meets requirements
---
